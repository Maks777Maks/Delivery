import TypeDishesGraphService from './TypeDishesGraphService';
...
export const getAllTypeDishesData = () => {
    return (dispatch) => {
        dispatch(getListActions.started());
console.log("Dispatch");
TypeDishesGraphService.getAllTypeDishes()
            .then((response) => {
...
export const getAllTypeDishesReducer = (state = initialState, action) => { 
  let newState = state;
